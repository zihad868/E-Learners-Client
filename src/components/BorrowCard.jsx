...
const BorrowCard = ({ borrow, deleted, setDeleted }) => {
        ...
        <div className="card w-full bg-base-100 shadow-xl">
          ...
          <div className="card-body">
            ...
            <div className="card-actions justify-between">
              <div
                onClick={() => handleReturn(borrow?.bookId, borrow?._id)}
                className="w-full text-center rounded-lg px-1 py-2 bg-secondary text-white"
              >
                Return
              </div>
            </div>
